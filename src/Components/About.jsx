      ...
      <div className="hero min-h-screen my-10 flex">
         ...
         <div className="hero-content flex-col lg:flex-row-reverse mb-10 md:mb-0 ">
            ...
            <div className="lg:w-[500px] ">
               ...
               <p className="py-8">I am a computer science student at Daffodil International University. My academic journey has provided me with a solid foundation in computer science and programming, and I'm excited to apply my knowledge in a real-world setting. I am passionate about web development</p>
               <p className="pb-8">As a passionate web developer with a strong foundation in MERN technologies, including HTML, CSS JavaScript, React.Js, Express.Js, Jwt, Node.js, Google Firebase, MongoDB, Payment-Gateways, I have successfully designed and developed interactive and visually appealing websites. My experience and skills in creating responsive, user-friendly web interfaces have equipped me with the ability to craft compelling user experiences. I believe that learning and mastering these technologies will enable me to create more dynamic and feature-rich web applications.</p>
               <div>
