         ...
         <div className="relative flex flex-col md:flex-row bg-clip-border border-4 border-lime-400 rounded-xl bg-white text-gray-700 shadow-md w-full ">
            <div className="relative w-full md:w-2/5 m-0 overflow-hidden text-gray-700 bg-white rounded-r-none bg-clip-border rounded-xl shrink-0">
               <div className="carousel w-full">
                  ...
                  <div id="item17" className="carousel-item w-full">
                     <img src={Img4} className="w-full" />
                  </div>
                  <div id="item18" className="carousel-item w-full">
                     <img src={Img5} className="w-full" />
                  </div>
               </div>
               <div className="flex justify-center w-full py-2 gap-2">
                  <a href="#item14" className="btn btn-xs">1</a>
                  <a href="#item15" className="btn btn-xs">2</a>
                  <a href="#item16" className="btn btn-xs">3</a>
                  <a href="#item17" className="btn btn-xs">4</a>
                  <a href="#item18" className="btn btn-xs">5</a>
               </div>
